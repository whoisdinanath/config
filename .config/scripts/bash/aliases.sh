...
alias project="xrandr --output HDMI-1  --auto --scale-from  1920*1080 --output eDP-1 --off"
alias extend="xrandr --output HDMI-1 --auto --scale-from  1920*1080 --output eDP-1 --auto --right-of HDMI-1"

alias mirror="xrandr --output HDMI-1 --auto --scale-from 1920*1080 --output eDP-1 --auto --same-as HDMI-1"
